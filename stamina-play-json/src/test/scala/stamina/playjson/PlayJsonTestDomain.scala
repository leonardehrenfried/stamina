package stamina.playjson

import play.api.libs.json.Json

object PlayJsonTestDomain {
  type ItemId = Int
  type CartId = Int
  ...
  object Formats {
    implicit val itemV1 = Json.format[ItemV1]
    implicit val cartV1 = Json.format[CartV1]
    implicit val cartCreatedV1 = Json.format[CartCreatedV1]

    implicit val itemV2 = Json.format[ItemV2]
    implicit val cartV2 = Json.format[CartV2]
    implicit val cartCreatedV2 = Json.format[CartCreatedV2]

    implicit val itemV3 = Json.format[ItemV3]
    implicit val cartV3 = Json.format[CartV3]
    implicit val cartCreatedV3 = Json.format[CartCreatedV3]
  }
